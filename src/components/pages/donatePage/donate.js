        ...
        <div className="donateParent">
            ...
            <div className="donateDescription">        
                ...
                <h2>Financial Contributions:</h2>
                    <p>We welcome monetary donations to further our mission. All contributions will be directly utilized to acquire the aforementioned goods or to sponsor community-building events. Your support can make a tangible difference in the lives of these 83 families!</p>
            </div>
