        ...
        <div className="bBallParent">
            <div className="bBallContent">
                <div className="bBallRunBox">
                    ...
                    <motion.div className="registrationButton" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.8 }}>
                        <a className="buttonLink" href="https://forms.gle/zHy7besQ7rEVw8fX6" target="_blank" rel="noopener noreferrer">Register Here!</a>
                    </motion.div>
